...
4. You can export reviews to xls files from the **Download** tap, and it is limited to exporting 800 reviews. Please use the date pickers to select the time range of reviews you want to export.
